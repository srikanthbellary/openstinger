...
**Recommended for Nanobot:** Start with **Mode 1 (Alongside)**. Move to **Mode 3 (Exclusive)** quickly — Nanobot's built-in memory is intentionally minimal. OpenStinger is the intended memory destination for Nanobot's "small core, external everything" philosophy.
